...
import { IconCopy, IconEye, IconEyeOff, IconShieldCheck } from "@tabler/icons-react";
      ...
      <Row className="justify-content-center w-100 mx-0"><Col md={9} lg={7} xl={6}>
        <Card className="border-0 shadow-sm"><Card.Body className="p-4 p-md-5">
          <div className="text-center mb-4">
            ...
            <h1 className="h3 mb-2">Create your organization workspace</h1><p className="text-secondary mb-0">Set up the company owner account and receive a secure code for employee onboarding.</p></div>
          {inviteCode ? (
