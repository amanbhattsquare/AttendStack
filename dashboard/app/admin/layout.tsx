      ...
      <div>
        ...
        <div id='content' className='position-relative min-vh-100 d-flex flex-column' style={{ minHeight: "100vh" }}>
          ...
          <footer className='custom-container mt-auto pt-3 pb-1 text-muted small border-top' style={{ borderColor: '#f1f5f9' }}>
            <span className='me-1'>© 2026 AttendStack. A <a href="https://bhattsquare.com" target="_blank" rel="noopener noreferrer" className="text-primary fw-medium text-decoration-none">Bhatt Square</a> Project. <span className='text-secondary ms-2'>Version 2.5.4</span></span>
          </footer>
        </div>
      </div>
    </BrandingProvider>
