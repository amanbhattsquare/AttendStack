...
function TaskTableRowsWithSubtasks({ task, index, subtasksByParent, expanded, projectColors, employeeMode, onToggleSubtasks, onOpenDetail, onAddSubtask, onEdit, onProgress, onDelete }: { task: Task; index: number; subtasksByParent: Record<string, Task[]>; expanded: boolean; projectColors: Record<string, string>; employeeMode: boolean; onToggleSubtasks: (taskId: string) => void; onOpenDetail: (task: Task) => void; onAddSubtask: (task: Task) => void; onEdit: (task: Task) => void; onProgress: (task: Task) => void; onDelete: (task: Task) => void }) {
