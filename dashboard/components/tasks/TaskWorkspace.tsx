...
export default function TaskWorkspace({ employeeMode = false }: { employeeMode?: boolean }) {
  ...
  return <div className="container-fluid px-0 py-4 task-workspace">
    ...
    <style suppressHydrationWarning>{styles}{heroStyles}{taskTableStyles}{detailStyles}{tableEnhancements}{projectColorStyles}{paginationStyles}{categoryRemovalStyles}{datePlannerStyles}</style>
  </div>;
}
