...
.workspace-project{border-top-color:var(--project-color,#4f46e5)!important;background:linear-gradient(135deg,var(--project-tint,rgba(79,70,229,.16)) 0%,#fff 82%)!important}.workspace-project .progress-bar{background-color:var(--project-color,#4f46e5)!important}.task-project-badge{display:inline-flex;align-items:center;border:1px solid transparent;border-radius:5px!important;padding:3px 6px!important;font-size:.64rem!important;font-weight:800!important;letter-spacing:.04em;line-height:1}
`;
